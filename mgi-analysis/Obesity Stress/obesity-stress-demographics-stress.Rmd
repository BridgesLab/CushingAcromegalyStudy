...
Stress is defined as high or low, based on whether the participant is above or below the median value (`r median(combined.data$Stress_d1,na.rm=T)`).
...
```{r stress-type2-counts-t2d-stats}
...
rbind(stress.race %>% rename("Group"="Race.Ethnicity"),
  ...
  select(Group,Total,Percent, No,Yes,Prevalence)-> summary.table
