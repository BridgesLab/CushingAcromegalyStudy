...
```{r diabetes-type2-counts-race-ethnicity}
combined.data %>%
  filter(!(is.na(Stress))) %>%
...
```{r diabetes-type2-counts-race-ethnicity-stats}
library(broom)
...
```{r diabetes-type2-counts-gender}
combined.data %>%
  filter(!(is.na(Stress))) %>%
  filter(!(is.na(BMI_cat.Ob.NonOb))) %>%
...
```{r diabetes-type2-counts-gender-bmi}
diabetes.gender.bmi %>%
...
```{r diabetes-type2-counts-gender-stats}
library(broom)
...
```{r diabetes-type2-counts-age-stats}
...
```{r diabetes-type2-counts-disadvantage}
combined.data %>%
  filter(!(is.na(Stress))) %>%
  filter(!(is.na(BMI_cat.Ob.NonOb))) %>%
...
```{r diabetes-type2-counts-disadvantage-stats}
...
```{r diabetes-type2-counts-bmi-stats}
