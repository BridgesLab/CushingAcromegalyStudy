...
The average age of our participants is `r mean(combined.data$age, na.rm=T)` with a standard error of `r sd(combined.data$age, na.rm=T)/sqrt(nrow(combined.data)))`.
...
The average BMI of our participants is `r mean(combined.data$BMI, na.rm=T)` with a standard deviation of `r sd(combined.data$BMI, na.rm=T)/sqrt(nrow(combined.data))``.
