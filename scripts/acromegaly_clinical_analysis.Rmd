...
glucose.data <- subset(melted.data.used, measurement %in% glucose.data.vars)
...
clinical.data <- subset(melted.data.used, measurement %in% clinical.data.vars)
...
lipid.data <- subset(melted.data.used, measurement %in% lipid.data.vars)
...
lipolysis.data <- subset(melted.data.used, measurement %in% lipolysis.data.vars)
...
all.o2 <- ddply(melted.data.used, .(measurement), summarise, pval=t.test(value ~ diagnosis)$p.value)
...
library(xtable) 
print(xtable(glucose.summary.table, digits=c(rep(1,6),5,5)), type='html') 
print(xtable(clinical.summary.table, digits=c(rep(1,6),5,5)), type='html') 
print(xtable(lipid.summary.table, digits=c(rep(1,6),5,5)), type='html') 
print(xtable(lipolysis.summary.table, digits=c(rep(1,6),5,5)), type='html') 
print(xtable(all.summary.table, digits=c(rep(1,6),5,5)), type='html') 
``` 
