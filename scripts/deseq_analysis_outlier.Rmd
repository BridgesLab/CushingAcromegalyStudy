...
The counts tables were generated previously using the **counts_table.Rmd** script.  It removes the outlier data point from the analysis, which was patient **`r remove_patient`**.
