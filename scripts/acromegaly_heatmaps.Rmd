...
analysis.file <- "../data/processed/Annotated_Results_GRCh37.74_Acromegaly_age.csv"
analysis.data <- read.csv(analysis.file, row.names='Row.names')
...
```{r acromegaly-de-heatmap, dev=c('png','pdf'), echo=FALSE, fig.show='asis', warning=FALSE, message=FALSE}
...
dev.copy(pdf, '../figures/Acromegaly-differential-expressor-heatmap-RPKM.pdf')
dev.off()
