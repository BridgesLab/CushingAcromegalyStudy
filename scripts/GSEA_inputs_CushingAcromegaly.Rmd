...
deseq2.Cushing <- "../data/processed/Annotated_Results_GRCh37.74_Cushings_bmi.csv"
...
Acromegaly.results.noNA <- Acromegaly.results.noNA[order(Acromegaly.results.noNA$log2FoldChange),]
...
cushing.results.noNA <- cushing.results.noNA[order(cushing.results.noNA$log2FoldChange),]
