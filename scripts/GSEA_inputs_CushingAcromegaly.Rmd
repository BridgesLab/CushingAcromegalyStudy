...
write.table(exp_Acro, file="../data/processed/GSEA_Acromegaly_input_htseq_DEseq2.txt", sep="\t", col.names=NA)
...
write.table(exp_Cushing, file="../data/processed/GSEA_Cushing_input_htseq_DEseq2.txt", sep="\t", col.names=NA)
```
