...
exp_Acromegaly_geneName <- merge(exp_file, deseq2.Acromegaly.results, by.x="genes", by.y="external_gene_id")
exp_Cushing_geneName <- merge(exp_file, deseq2.Cushing.results, by.x="genes", by.y="external_gene_id")
...
write.table(exp_Acro, file=acromegaly_data_file, sep="\t")
...
write.table(exp_Cushing, file=cushing_data_file, sep="\t")
```
