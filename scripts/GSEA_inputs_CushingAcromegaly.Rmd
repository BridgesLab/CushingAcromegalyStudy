...
Acromegaly.results.noDup.0.60 <- Acromegaly.results.noNA.0.60[!duplicated(Acromegaly.results.noNA$external_gene_id),]
...
This script takes the input files `r deseq2.Cushing`, `r cushing.obese`, and `r deseq2.Acromegaly`.  This script was most recently run on `r date()`.  It writes out 5 data files `r cushing_data_file`, `r cushing_obese_file`, `r cushing_notobese_file`, `r acromegaly_data_file_0.60`, and `r acromegaly_data_file_60.100`.
