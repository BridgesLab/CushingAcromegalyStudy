...
```{r quad-anova}
ewat.aov.int <- aov(Quad ~ Diet + Group + Diet:Group, data=data)
ewat.aov <- aov(Quad ~ Diet + Group, data=data)
```

```{r quad-levene}
levene.hfd.ewat <- leveneTest(Quad ~ Group, data = filter(data, Diet=="HFD"))
levene.ncd.ewat <- leveneTest(Quad ~ Group, data = filter(data, Diet=="NCD"))
```
...
```{r ts-anova}
ewat.aov.int <- aov(TS ~ Diet + Group + Diet:Group, data=data)
ewat.aov <- aov(TS ~ Diet + Group, data=data)
```

```{r ts-levene}
levene.hfd.ewat <- leveneTest(TS ~ Group, data = filter(data, Diet=="HFD"))
levene.ncd.ewat <- leveneTest(TS ~ Group, data = filter(data, Diet=="NCD"))
```
