...
library(forcats)
combined_data$Food <- fct_recode(combined_data$Food, "Normal Chow Diet"="NCD", "High Fat Diet"="HFD" )
...
qpcr.summary <-
  ...
  group_by(Gene) %>%
  mutate(Rel.values = Norm.values/mean(Norm.values[Food=="Normal Chow Diet"&Treatment=="Water"])) %>%
