...
combined.bc.data <-
  body.comp.data %>%
  full_join(weekly.summary.data, by=c("Treatment"="Treatment","Diet"="Diet","Week"="WEEK")) %>%
...
For a 70 kg human that is an effective dose range of **`r human.data$Human.dose[1]*70`** to **`r human.data$Human.dose[3]*70`** mg
