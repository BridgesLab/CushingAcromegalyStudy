...
filename <- 'NADH NBT CSA Data.csv' #make this a separate line, you can use any variable you want
...
ggplot(aes(y=Mean,
  ...
  geom_errorbar(position=position_dodge(width=0.75),aes(group=Treatment), width=0.5) +
  expand_limits(y = 0) +
  labs(y="Percent of Oxidative Muscle Fibers",
...
coef(summary(csa.lme.dark)) %>% kable(caption="Coefficient table for mixed linear model.")
