...
acro.age.res$log2FC_OldvsYoung_Acro <- results(acro.cds.age, contrast=c("agexGroup","Acromegaly..60.100.","Acromegaly..40.60."))$log2FoldChange
acro.age.res$lfcSE_OldvsYoung_Acro <- results(acro.cds.age, contrast=c("agexGroup","Acromegaly..60.100.","Acromegaly..40.60."))$lfcSE
acro.age.res$pvalue_OldvsYoung_Acro <- results(acro.cds.age, contrast=c("agexGroup","Acromegaly..60.100.","Acromegaly..40.60."))$pvalue
acro.age.res$padj_OldvsYoung_Acro <- results(acro.cds.age, contrast=c("agexGroup","Acromegaly..60.100.","Acromegaly..40.60."))$padj
...
sig.4060 <- subset(acro.age.Wald, padj_AcrovsCon_40.60<0.05)
sig.4060 <- sig.4060$external_gene_id
...
write.csv(sig.4060, "../data/processed/Acro_vs_Control_Young_Sig_Genes.csv")
```
Adjusting for age
----------------
