...
for (gene in genes.of.interest) {
  ...
  ggsave(filename=paste('../figures/Age/Acro-Age-',gene,'-barplot.pdf',sep=""))
}
...
ggsave("../Figures/Age/Acro-Age-adjusted-all-lipases-RPKM.pdf")
...
for (gene in lipases) {
  ...
  ggsave(filename=paste('../Figures/Age/Acro-Age-lipase-',gene,'-barplot.pdf',sep=""))
}
```
...
for (name in gene.data.name){
  ...
  ggsave(filename=paste('../Figures/Age/Acro-Age', name, '-barplot.pdf',sep=""))
}
...
pdf('../Figures/Age/Acromegaly_Age_FASN_Combined.pdf')
multiplot(plot_figure4C,plot_figure4C_FASN, cols=2)
dev.off()

pdf('../Figures/Age/Acromegaly_Age_SCD_Combined.pdf')
