...
gene.data.name <- c('figureXX', 'fos_jun', 'figure1B', 'figure1C', 'figure1D', 
                    'figure4A', 'figure4C', 'figure4D', 'sup1E', 'sup2A', 'sup2B','igf_complex','rgs_isoforms','ags_isoforms','ptps','socs_isoforms','ptpn_figure','lipolysis_genes','glucocorticoids')
