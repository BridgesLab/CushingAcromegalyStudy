...
cds.cushing.obese = DESeqDataSetFromMatrix(countData=cushing.counts.obese, colData=cushing.mapping.obese, design=~age+group)
...
cushing.long2 <- reshape(cushing.counts, direction="long", 
                           ids=rownames(cushing.counts), idvar="Genes",
                           varying=colnames(cushing.counts), v.names="Fitted_Values",
                           timevar="Age",times=cushing.mapping.obese$age)
...
plot(Residuals~Disease, cushing.residuals.long, main="Obese patients")
