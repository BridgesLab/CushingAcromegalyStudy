...
cushing.mapping$ageGroup <- cut(cushing.mapping$age, breaks=c(0,59,100))
```
...
cds.cushing.notObese = DESeqDataSetFromMatrix(countData=cushing.counts.notObese, colData=cushing.mapping.notObese, design=~age1+group)
