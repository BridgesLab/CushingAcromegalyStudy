...
cushing.results.bmi.age <- results(cushing.cds.bmi.age)
cush.results.bmi.midAge<- results(cushing.cds.bmi.age, contrast=c("ageGroup", ".40.60.", ".0.40."))
cush.results.bmi.oldAge<- results(cushing.cds.bmi.age, contrast=c("ageGroup", ".60.100.", ".0.40."))
