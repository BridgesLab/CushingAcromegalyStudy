...
This analysis included `r as.numeric(summary(cushing.data$diagnosis)[1])-1` controls and `r as.numeric(summary(cushing.data$diagnosis)[2])` cushing patients. 
...
test_output_file <- "../data/processed/Clinical Test Parameters.csv"
...
plot <- with(glucose.summary.table, 
     barplot(cbind(Control_mean[2], Cushing_mean[2]),
             names.arg=c("Control", "Cushing's"),
             main="HOMA Score",las=1,
             ylim=c(0,11)))
with(glucose.summary.table, superpose.eb(plot, cbind(Control_mean[2], Cushing_mean[2]), cbind(Control_se[2], Cushing_se[2])))
dev.off()
...
plot <- with(glucose.summary.table, 
     barplot(cbind(Control_mean[1], Cushing_mean[1]),
             names.arg=c("Control", "Cushing's"),
             main="Fasting Blood Glucose",
             ylab="Glucose (mg/dL)",las=1,
             ylim=c(0,115)))
with(glucose.summary.table, superpose.eb(plot, cbind(Control_mean[1], Cushing_mean[1]), cbind(Control_se[1], Cushing_se[1])))
dev.off()
...
#Insulin
plot <- with(glucose.summary.table, 
     barplot(cbind(Control_mean[3], Cushing_mean[3]),
             names.arg=c("Control", "Cushing's"),
             main="Fasting Insulin",
             ylab="Serum Insulin (pg/mL)",
             las=1,
             ylim=c(0,35)))
with(glucose.summary.table, superpose.eb(plot, cbind(Control_mean[3], Cushing_mean[3]), cbind(Control_se[3], Cushing_se[3])))
...
plot <- with(lipolysis.summary.table, 
     barplot(cbind(Control_mean[7], Cushing_mean[7]),
             names.arg=c("Control", "Cushing's"),
             main="Basal Lipolysis",
             ylab="Glycerol Release",
             las=1,
             ylim=c(0,18)))
with(lipolysis.summary.table, superpose.eb(plot, cbind(Control_mean[7], Cushing_mean[7]), cbind(Control_se[7], Cushing_se[7])))
dev.off()
...
plot <- with(lipolysis.summary.table, 
     barplot(cbind(Control_mean[5], Cushing_mean[5]),
             names.arg=c("Control", "Cushing's"),
             main="Isoproternol Stimulated Lipolysis",
             ylab="Glycerol Release",
             las=1,
             ylim=c(0,30)))
with(lipolysis.summary.table, superpose.eb(plot, cbind(Control_mean[5], Cushing_mean[5]), cbind(Control_se[5], Cushing_se[5])))
dev.off()
...
pdf("../figures/Combined Lipolysis Barplot.pdf")
plot <- with(lipolysis.summary.table, 
     barplot(cbind(rbind(Control_mean[7], Cushing_mean[7]),rbind(Control_mean[5], Cushing_mean[5])),
...
with(lipolysis.summary.table, superpose.eb(plot, 
    cbind(rbind(Control_mean[7], Cushing_mean[7]),rbind(Control_mean[5], Cushing_mean[5])),
    cbind(rbind(Control_se[7], Cushing_se[7]),rbind(Control_se[5], Cushing_se[5]))))
...
plot <- with(all.summary.table[all.summary.table$measurement=='age',], 
     barplot(cbind(Control_mean, Cushing_mean),
             names.arg=c("Control", "Cushing's"),
             main="Age",
             ylab="Years",
             las=1,             col=grey.colors(2)[2],
             ylim=c(0,70)))
with(all.summary.table[all.summary.table$measurement=='age',], superpose.eb(plot, cbind(Control_mean, Cushing_mean), cbind(Control_se, Cushing_se)))
...
plot <- with(all.summary.table[all.summary.table$measurement=='height',], 
     barplot(cbind(Control_mean, Cushing_mean),
             ...
             las=1,             col=grey.colors(2)[2],
             ylim=c(0,185)))
with(all.summary.table[all.summary.table$measurement=='height',], superpose.eb(plot, cbind(Control_mean, Cushing_mean), cbind(Control_se, Cushing_se)))
...
plot <- with(all.summary.table[all.summary.table$measurement=='largest.diameter.of.tumor',], 
     barplot(cbind(Control_mean, Cushing_mean),
             ...
             las=1,             col=grey.colors(2)[2],
             ylim=c(0,2.2)))
with(all.summary.table[all.summary.table$measurement=='largest.diameter.of.tumor',], superpose.eb(plot, cbind(Control_mean, Cushing_mean), cbind(Control_se, Cushing_se)))
dev.off()
...
plot <- with(all.summary.table[all.summary.table$measurement=='weight',], 
     barplot(cbind(Control_mean, Cushing_mean),
             ...
             las=1,             col=grey.colors(2)[2],
             ylim=c(0,115)))
with(all.summary.table[all.summary.table$measurement=='weight',], superpose.eb(plot, cbind(Control_mean, Cushing_mean), cbind(Control_se, Cushing_se)))
...
plot <- with(all.summary.table[all.summary.table$measurement=='BMI',], 
     barplot(cbind(Control_mean, Cushing_mean),
             ...
             las=1,             col=grey.colors(2)[2],
             ylim=c(0,35)))
with(all.summary.table[all.summary.table$measurement=='BMI',], superpose.eb(plot, cbind(Control_mean, Cushing_mean), cbind(Control_se, Cushing_se)))
...
plot <- with(all.summary.table[all.summary.table$measurement=='abdominal.circumference',], 
     barplot(cbind(Control_mean, Cushing_mean),
             ...
             las=1,             col=grey.colors(2)[2],
             ylim=c(0,115)))
with(all.summary.table[all.summary.table$measurement=='abdominal.circumference',], superpose.eb(plot, cbind(Control_mean, Cushing_mean), cbind(Control_se, Cushing_se)))
dev.off()
...
legend("topleft", levels(cushing.data$diagnosis)[1:2], pch=19, bty="n", col=palette()[1:2], lty=1)
with(cushing.data[cushing.data$diagnosis == "Control"&cushing.data$id!='29',], abline(lm(log(HOMA.IR)~BMI), col=palette()[1]))
with(cushing.data[cushing.data$diagnosis == "Cushing's"&cushing.data$id!='29',], abline(lm(log(HOMA.IR)~BMI), col=palette()[2]))
dev.off()
```
### Model Diagnostics
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='HOMA.IR',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             names.arg=c("Control", "Cushing's", "Outlier"),
             main="HOMA Score",las=1,
             ylim=c(0,12)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='HOMA.IR',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
dev.off()
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='glucose',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             ylab="Glucose (mg/dL)",
             ylim=c(0,135)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='glucose',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
dev.off()
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='insulin',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=1,
             ylim=c(0,38)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='insulin',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
dev.off()
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='glycerol.no.tx',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=1,
             ylim=c(0,18)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='glycerol.no.tx',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
dev.off()
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='glycerol.iso.30.nM',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=1,
             ylim=c(0,32)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='glycerol.iso.30.nM',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
dev.off()
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='age',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=2,
             ylim=c(0,70)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='age',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='height',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=2,
             ylim=c(0,190)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='height',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='weight',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=2,
             ylim=c(0,120)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='weight',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='BMI',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=2,
             ylim=c(0,45)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='BMI',], superpose.eb(plot, cbind(Control_mean, Cushing_mean, value), cbind(Control_se, Cushing_se,0)))
...
plot <- with(outlier.all.summary.table[outlier.all.summary.table$measurement=='abdominal.circumference',], 
     barplot(cbind(Control_mean, Cushing_mean,value),
             ...
             las=2,
             ylim=c(0,115)))
with(outlier.all.summary.table[outlier.all.summary.table$measurement=='abdominal.circumference',], superpose.eb(plot, cbind(Control_mean, Cushing_mean,value), cbind(Control_se, Cushing_se,0)))
dev.off()
```
...
pdf('../figures/Ceramide Levels.pdf')
