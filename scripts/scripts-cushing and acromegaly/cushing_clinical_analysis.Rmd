...
We next tested, for the normally distributed data, whether the data had unequal variance.  This was done using Levene's test in the car package .  A Welch's t-test for unequal variance was appropriate for `r rownames(test.summary.table[test.summary.table$test == "Welch's T-Test",])` based on p<0.05.  In all other cases, a t-test, presuming equal variance was used.
...
pdf("../figures/Cushing - HOMA and Glucose Barplot.pdf")
par(mfrow=c(1,3))
#HOMA Score
...
```{r outlier-barplots-cushing, echo=FALSE, warning=FALSE, messages=FALSE}
...
```{r ceramides-barplots-cushing, echo=FALSE, warning=FALSE, messages=FALSE}
