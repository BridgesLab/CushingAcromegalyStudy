...
filtered_counts_filename <- "../data/processed/VSD_DESeq2_Results-Cushing.csv"
filtered.counts <- read.csv(filtered_counts_filename)
...
rownames(filtered.counts.cushing) <- filtered.counts$X
...
#write.csv(counts.rpkm, file="../data/processed/RPKM_VSD_Acromegaly_GRCh37.74.csv")
