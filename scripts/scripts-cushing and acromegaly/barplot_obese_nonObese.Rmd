...
for (item in glucose.data.vars) {
  ...
  ggsave(filename=paste('../../data/Figures/Cushing_BMI/Cushing-BMI-', item, '-barplot.pdf',sep=""))
}
...
ggsave("../../data/Figures/Cushing_BMI/Cushing-BMI-lipolysis-barplot.pdf")
...
ggplot(glucose.stat, aes(x=measurement, y=mean, fill=diagnosis))+
    ...
    theme(text = element_text(size=20), axis.text.x = element_text(angle=70,hjust=.5,vjust=.5)) +
    theme(legend.position=c(.60,.90))
ggsave("../../data/Figures/Cushing_BMI/Cushing-BMI-glucosePanel-barplot.pdf")
...
ggplot(clinical.stat, aes(x=measurement, y=mean, fill=diagnosis))+
    ...
    theme(text = element_text(size=20), axis.text.x = element_text(angle=70,hjust=.5,vjust=.5)) +
    theme(legend.position=c(.60,.90))
ggsave("../../data/Figures/Cushing_BMI/Cushing-BMI-clinicalPanel-barplot.pdf")
...
ggplot(liver.stat, aes(x=measurement, y=mean, fill=diagnosis))+
    ...
    theme(text = element_text(size=20), axis.text.x = element_text(angle=70,hjust=.5,vjust=.5)) +
    theme(legend.position=c(.60,.90))
ggsave("../../data/Figures/Cushing_BMI/Cushing-BMI-liverPanel-barplot.pdf")
```
