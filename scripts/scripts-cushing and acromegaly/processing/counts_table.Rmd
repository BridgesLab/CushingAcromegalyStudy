...
------------------------------------------
Bowtie2 was used to align these samples to the **ENSEMBL_M37** reference genome with a gtf file from release **69**.  
  

Gene Counts Table
#################

First databases of exons and transcripts are generated from the Ensembl genome assembly.  The current biomart release of ensembl is M37.69

```{r gene-counts-setup, echo=TRUE}
require(GenomicFeatures)
require(biomaRt)
#make a database of transcripts from the ensembl assembly
#first get the archived release 39 from ensembl
txdb <- makeTranscriptDbFromBiomart(host='http://oct2012.archive.ensembl.org/',
biomart="ensembl",dataset = 'hsapeins_gene_ensembl')
...
sample_ids = seq(12100,12101,12102,12103,12104,12105,12106,12107,12108,12109
12110,12111,12112,12113,12114,12115,12117,12118,12119,12120,12121,12125,12126,12127,12128)
