...
deseq.filename <- "../../data/processed/Annotated_Results_Cushings_NotObese_and_Obese.csv"
#read in the file
...
#paste gene here
genes.of.interest <- c("NR3C1","NR3C2","KLF5","CDKN2B","FASN","GYS1","GYS2","GBE1","HLA-DRB1","IDH1","LDHA","LDHB","PSMD8","SCD","FASN","HSD11B1","LEP","TSC22D3")
...
for (gene in genes.of.interest) {
  ...
  ggsave(filename=paste('../../data/Figures/Cushing_BMI/Cushing-BMI-',gene,'-barplot.pdf',sep=""))
}
...
ggsave("../../data/Figures/Cushing_BMI/Cushing-BMI-all-lipases-RPKM.pdf")
...
for (gene in lipases) {
  ...
  ggsave(filename=paste('../../data/Figures/Cushing_BMI/Cushing-BMI-lipase-',gene,'-barplot.pdf',sep=""))
}
...
for (gene in obese.sig.genes) {
  ...
  ggsave(filename=paste('../../data/Figures/Cushing_BMI/Cushing-Obese-',gene,'-barplot.pdf',sep=""))
}
```
...
gene.data.name <- c('igf_complex','rgs_isoforms','ags_isoforms', 'lipid_metabolism', 'tg_synthesis','carb_metabolism','cortisol_signaling','tca_citric_acid', 'bcaa_degradation','interferon_signaling','intferon_gamma','interferon_gamma_no_b2m','IRF_isoforms','activin','hla_genes_hi','M_PHASE_OF_MITOTIC_CELL_CYCLE','STEROID_BIOSYNTHETIC_PROCESS','REACTOME_TRIGLYCERIDE_BIOSYNTHESIS','KEGG_BIOSYNTHESIS_OF_UNSATURATED_FATTY_ACIDS','PROTEASOME_COMPLEX','KEGG_VALINE_LEUCINE_AND_ISOLEUCINE_DEGRADATION','KEGG_RIBOSOME','KEGG_CITRATE_CYCLE_TCA_CYCLE','KEGG_PYRUVATE_METABOLISM','KEGG_STARCH_AND_SUCROSE_METABOLISM','KEGG_ALLOGRAFT_REJECTION','M_PHASE_OF_MITOTIC_CELL_CYCLE_no_CDKN2B','MITOCHONDRIONsub','CALMODULIN_BINDING','KEGG_LYSOSOME','KEGG_LYSOSOME_high','ATP_SYNTHASE')
...
for (name in gene.data.name){
  ...
  ggsave(filename=paste('../../data/Figures/Cushing_BMI/Cushing-BMI-', name, '-barplot.pdf',sep=""))
}
