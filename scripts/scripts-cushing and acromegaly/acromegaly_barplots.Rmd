...
genes.of.interest <- c("IGF1", "IGFBP3", "IGFBP5","IGFALS","CISH", "SOCS2", "ADRB3", "TSHR", "TCF7L2", "PYGM","HSD11B1","LPL","PGM3","NR3C1","MVP", "SCD", "APOL4", "PTPN3", "PTPN4","CCNE1","CCNG1", "CDKN2B", "CDKN2B-AS1", "NAP1L1","ORC2", "PDGFD", "RARB","PGRMC1","SCDP1","SCP2", "MAP3K5","MAPK13","MAPKAPK3","MATN2","MFAP4","MMRN2", "NRIP1","MMD","ABHD5","LEPR","ACVR1C","GFPT1","CYB5A","AVPR1A","PTGER3","PDE3B","FADS2","LIPE","PNPLA2", "MGLL","AKT1", "AKT2","AKT3", "INSR", "IRS1", "IRS2", "IRS4", "SLC2A4", "PIK3R1","BAG4","CAPN6","G0S2","PPARG", "PPARA","SERPINA6", "LEPR", "LEP", "ENPP5", "GPR64", "SLC29A1", "SLC2A13", "MAP1LC3C", "PNPLA3", "APOL4", "ARHGAP32", "ZNF217", "CXCL13", "FGF17", "SLC4A1", "SERPINI2", "HLA-DPB1","HLA-DPA1","HLA-DQB1","HLA-DPB1","JUN","FOS","FAM47E-STBD1","STBD1")
...
for (gene in genes.of.interest) {
  ...
  ggsave(filename=paste('../../data/figures/Acromegaly-',gene,'-barplot.pdf',sep=""))
}
...
ggsave("../../data/figures/Acromegaly-all-lipases-RPKM.pdf")
...
for (gene in lipases) {
  ...
  ggsave(filename=paste('../../data/Figures/Acromegaly-lipase-',gene,'-barplot.pdf',sep=""))
}
```
...
fos_jun <- c("FOS","JUN","JUNB")
ptpn_figure <- c("PTPN3", "PTPN4")
...
lipolysis_genes <- c("ABHD5","NRIP1","ADRB1", "ADRB2", "ADRB3")
figure4C <- c("ACSS2","ACSS3","AACS","ACACA","ACSL3", "AGPAT9")
figure4C_FASN <- c("FASN","AGPAT2")
figure4D <- c("FADS1","FADS2")
figure4D_SCD <- c("SCD")
sup1E <- c("UGP2", "PYGM")
sup2A <- c("INSR","IRS1","IRS2","AKT1","AKT2","AKT3","SLC2A4")
sup2B <- c("STAT6","IKBKB","IL1B","IL6","MCP1","IKBKE")
glucocorticoids <- c("HSD11B1","HSD11B2","NR3C1","NR3C2")
...
lipolysis_regulators <- c('CIDEA','CIDEB','CIDEC','G0S2')

gene.data.name <- c('figureXX', 'fos_jun', 'figure1B', 'figure1C', 'figure1D', 
                    'figure4A', 'figure4C', 'figure4D', 'sup1E', 'sup2A', 'sup2B','igf_complex','rgs_isoforms','ags_isoforms','ptps','socs_isoforms','ptpn_figure','lipolysis_genes','glucocorticoids','lipolysis_regulators')
for (name in gene.data.name){
  ...
  ggsave(filename=paste('../../data/Figures/Acromegaly-', name, '-barplot.pdf',sep=""))
}
...
pdf('../../data/Figures/Acromegaly_FASN_Combined.pdf')
multiplot(plot_figure4C,plot_figure4C_FASN, cols=2)
dev.off()

pdf('../../data/Figures/Acromegaly_SCD_Combined.pdf')
