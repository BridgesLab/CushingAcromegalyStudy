...
mapping$age.cat <- cut(mapping$age, breaks=c(0,60,100))
mapping$age.cat <- ifelse(mapping$age.cat=="(0,60]", "Young", "Old")
...
old.sig.genes <- c("CPXM1", "SCD", "FADS2")
...
#TOO MANY GENES IN THE Young significant genes list to be drawn
