...
```{r clustering, echo=FALSE, dev=c('png','pdf'), echo=FALSE, fig.show='asis'}
#scaled the data
scaled.sample.transcript.counts <- scale(transcript.counts)
...
mapping.filtered <- mapping #subset(mapping, samplename != 'sample12128')
