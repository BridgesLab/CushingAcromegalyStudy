...
num_notDE_DM <- length(unique(methylation.data$Gene.Symbol))-nrow(combined.data.DE)
...
The Chi-sq p-value is `r Xsq$p.value`, indicating that there is no relationship between methylation and expression.

```{r Statisics-continue}
